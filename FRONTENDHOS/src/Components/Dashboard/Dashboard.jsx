...
<select class="form-select mt-2" aria-label="Default select example">
  ...
  <option value="services">Services</option>
        ...
        <div>
          ...
          <p className='text-center'>Discover a world class hotel experience with our carefully curated collection of luxury accommodations </p>
        </div>
        <div className="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
          {rooms.map((hotel) => (
        ...
        <div className='card map-card'>
          ...
          <div className={classes} onClick={() => setIsActive(!isActive)}>
            ...
            <div className='bg-white px-4 pb-4 pt-3-5'>
              <h5 className='card-title h5 living-coral-text'>Transcorp Hilton, Abuja</h5>
              <div className='d-flex justify-content-between living-coral-text'>
                <h6 className='card-subtitle font-weight-light'>A luxury hotel in Maitama.</h6>
              </div>
              <hr />
              ...
              <table className='table table-borderless'>
                <tbody>
                  <tr>
                    ...
                    <td className='pb-3 pt-2'>1 Aguiyi Ironsi Street,
Maitama, Abuja,
Nigeria.</td>
                  </tr>
                  <tr className='mt-2'>
                    ...
                    <td className='pb-3 pt-2'>
                      <span className='deep-purple-text me-2'> Closed</span> Opens 10 AM
                    </td>
                  </tr>
                  <tr className='mt-2'>
                    <th scope='row' className='px-0 pb-3 pt-2'>
      ...
      <section className='mx-auto my-5' style={{ maxWidth: '23rem' }}>
        <div className='card map-card'>
          ...
          <div className={classes} onClick={() => setIsActive(!isActive)}>
            ...
            <div className='bg-white px-4 pb-4 pt-3-5'>
              <h5 className='card-title h5 living-coral-text'>Nest, Ogbomosho</h5>
              <div className='d-flex justify-content-between living-coral-text'>
                <h6 className='card-subtitle font-weight-light'>A modern hotel in Ogbomoso.</h6>
              </div>
              <hr />
              <div className='d-flex justify-content-between pt-2 mt-1 text-center text-uppercase living-coral-text'>
                <div>
              ...
              <table className='table table-borderless'>
                <tbody>
                  <tr>
                    ...
                    <td className='pb-3 pt-2'>KM5, Ogbomoso-Ilorin Expressway,
                    </td>
                  </tr>
                  <tr className='mt-2'>
                    <th scope='row' className='px-0 pb-3 pt-2'>
        ...
        <div className='card map-card'>
          ...
          <div className={classes} onClick={() => setIsActive(!isActive)}>
            ...
            <div className='bg-white px-4 pb-4 pt-3-5'>
              <h5 className='card-title h5 living-coral-text'>Transcorp Hilton, Abuja</h5>
              <div className='d-flex justify-content-between living-coral-text'>
                <h6 className='card-subtitle font-weight-light'>A city to relax</h6>
              </div>
              <hr />
              <div className='d-flex justify-content-between pt-2 mt-1 text-center text-uppercase living-coral-text'>
                <div>
